...
| Variable        | Value           | Secured |
| ------------- |-------------||
| **apiUrl:**      | http://quizboxprodapiXX.azurewebsites.net/api ||
| **databaseLogin:**      | quizboxadmin ||
| **databasePassword:**      | P2ssw0rd | Yes |
...
| **databaseName:**      | quizbox ||
| **databaseServer:**      | quizboxprodXX.database.windows.net ||
| **databaseServerName:**      | quizboxprodXX ||
| **webSiteName:**      | quizboxprodXX ||
| **backendWebSiteName:**      | quizboxprodapiXX ||
...
1. Commit a change to the QuizBox repository. Try associating
...
5. Approve the release and verify that the release is being deployed to the production environment
